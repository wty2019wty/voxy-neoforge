...
public class SodiumConfigBuilder {
    ...
    private static class Enabler {
        final Predicate<ConfigState> tester;
        final ResourceLocation[] dependencies;
        Enabler(Predicate<ConfigState> tester, ResourceLocation[] dependencies) {
            this.tester = tester;
            this.dependencies = dependencies;
        }
        Enabler(Predicate<ConfigState> tester, String[] dependencies) {
